...
function encryptAadhaar(plain) {
    try {
        ...
        return `hash:${crypto_1.default.createHash('sha256').update(plain).digest('hex')}`;
    }
}
async function main() {
    ...
    const centreGuntur = await prisma.procurementCentre.upsert({
        ...
        update: { name: 'Guntur Agricultural Procurement Centre' },
        create: {
            id: 'centre-guntur-01',
    ...
    const centreTenali = await prisma.procurementCentre.upsert({
        ...
        update: { name: 'Tenali Procurement Centre' },
        create: {
            id: 'centre-tenali-02',
    ...
    const centreMangalagiri = await prisma.procurementCentre.upsert({
        ...
        update: { name: 'Mangalagiri Procurement Centre' },
        create: {
    ...
    const centreVijayawada = await prisma.procurementCentre.upsert({
        ...
        update: { name: 'Vijayawada Agricultural Procurement Centre' },
        create: {
    ...
    const passwordHash = await bcryptjs_1.default.hash('Kisan@123', 10);
